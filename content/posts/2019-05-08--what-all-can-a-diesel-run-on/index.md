...
**A diesel engine cannot run on clean gasoline**, but it can run on diesel mixed with gasoline, completely. The main thing is that the amount of this gasoline does not exceed **one-tenth** of the total volume of fuel. If this proportion increases, the engine will lose power and eventually will stop working altogether. ***Running a diesel on any amount of gasoline is not recommended*** 
